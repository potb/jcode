        ...
        json!({
            ...
            "properties": {
                ...
                "action": {
                    ...
                    "description": "Phase. Details investigates one candidate without selecting it; select commits and carries setup. Defaults to select when `tool` is set, else search. Suggest only when no product fits."
                },
                "category": {
                    "type": "string",
                    "enum": categories,
                ...
                "tool": {
                    ...
                    "minLength": 2,
                    "maxLength": 100,
                    "description": "For details or select: public product name. Details investigates the candidate; select records the choice. Off-catalog selections are recorded too."
                },
                "suggestion_kind": {
                    "type": "string",
...
mod tests {
    ...
    fn schema_is_compact_and_self_contained() {
        ...
        assert!(schema.contains("Details investigates one candidate without selecting it"));
