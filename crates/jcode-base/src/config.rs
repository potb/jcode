...
const CONFIG_ENV_KEYS: &[&str] = &[
    ...
    "JCODE_PIN_TODOS",
    "JCODE_PIN_USAGE",
    "JCODE_PREVENT_SLEEP_MIN_BATTERY_PERCENT",
    ...
    "JCODE_GITHUB_ISSUE_REPO",
    "JCODE_GITHUB_ISSUE_LABEL",
    "JCODE_GITHUB_TOKEN",
    "JCODE_GITHUB_REPLY_ENABLED",
    "JCODE_TODO_WIDGET",
    "JCODE_TOOL_CALL_DETAILS",
    "JCODE_TOOL_CALL_TIMINGS",
    "JCODE_TOOL_PROFILE",
    "JCODE_TOOLS",
