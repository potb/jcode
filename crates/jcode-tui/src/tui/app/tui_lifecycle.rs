...
impl App {
    ...
    pub(super) fn new_minimal_with_session(
        ...
        let mut app = Self {
            ...
            info_widget_data_cache: RefCell::new(None),
            info_widget_frame_active: std::cell::Cell::new(false),
            cursor_pos: 0,
            scroll_offset: 0,
            ...
            bg_panel_full_page: false,
            bg_panel_show_all_sessions: false,
            ...
            pending_detached_sessions: None,
            server_session_presence_requested_at: None,
